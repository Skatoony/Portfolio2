      ...
      <div className="relative z-10">
        ...
        <div className="w-full h-[30vh] md:h-[40vh] relative">
          <Image
            ...
            alt={project.title}
            fill
            className="object-cover opacity-60 blur-[8px]" // Increased blur from 2px to 8px
            priority
          />
        ...
        {/* Content */}
        <div className="max-w-6xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          {/* Main Content */}
